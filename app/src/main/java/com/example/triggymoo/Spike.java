...
public class Spike {
    ...
    public Spike(Context context){
        spike[0] = BitmapFactory.decodeResource(context.getResources(), R.drawable.bomb_cow0);
        spike[1] = BitmapFactory.decodeResource(context.getResources(), R.drawable.bomb_cow1);
        spike[2] = BitmapFactory.decodeResource(context.getResources(), R.drawable.bomb_cow2);
        random = new Random();
        resetPosition();
    }
